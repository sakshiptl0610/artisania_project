...
import { courses7 } from "@/data/courese";
          ...
          <div className="row items-center">
            <div className="col-lg-6">
              <div className="image-page-title2">
                ...
                >
                  {courses7.slice(0, 6).map((course, i) => (
            ...
            <div className="col-lg-6">
              <div className="content-page-title">
                ...
                <h6 className="wow fadeInUp" data-wow-delay="0.15s">
                  A Gond Painting Workshop is being held at Gallery Gitanjali,
                  Goa, featuring renowned artist Santosh Maravi.
                </h6>
              </div>
            </div>
          </div>
